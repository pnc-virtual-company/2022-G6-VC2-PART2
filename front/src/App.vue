  ...
  <div>
    <nav class="w-full flex justify-between items-center shadow-md bg-white" v-if='!$route.meta.hide'>
           ...
           <div class="w-[35%] flex justify-around">
              <router-link to="/profile" class="cursor-pointer hover:bg-[#0062ff] p-[10px] w-[20%] text-[#0062ff] hover:text-[#f8fafc] text-center" v-if="$route.meta.userRole=='alumni'">
              ...
              <router-link  to="/emploment" class="cursor-pointer hover:bg-[#0062ff] p-[10px] w-[20%] text-[#0062ff] hover:text-[#f8fafc] text-center" v-if="$route.meta.userRole=='alumni'">
              ...
              <router-link  to="/ero" class="cursor-pointer hover:bg-[#0062ff] p-[10px] w-[20%] text-[#0062ff] hover:text-[#f8fafc] text-center" v-if="$route.meta.userRole=='ero'">
                <svg class="w-7 h-7 m-auto" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 13.255A23.931 23.931 0 0112 15c-3.183 0-6.22-.62-9-1.745M16 6V4a2 2 0 00-2-2h-4a2 2 0 00-2 2v2m4 6h.01M5 20h14a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"></path></svg>
                <label class="text-[0.6rem]">Ero</label>
              </router-link>
              <router-link to="/event" class="cursor-pointer hover:bg-[#0062ff] p-[10px] w-[20%] text-[#0062ff] hover:text-[#f8fafc] text-center" v-if="$route.meta.userRole=='alumni'">
