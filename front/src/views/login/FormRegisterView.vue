                ...
                <form @submit.prevent="register">
                    ...
                    <div class="grid grid-cols-2 gap-2 w-[95%] m-auto">
                        ...
                        <div class="mb-4">
                            <input type="text"
                                class="w-full px-3 py-1.5 border border-gray-300 rounded focus:border-blue-600 focus:outline-none"
                                placeholder="Telegram" v-model="telegram" />
                        </div>
                        <div class="mb-4">
                            <input type="text"
                                class="w-full px-3 py-1.5 border border-gray-300 rounded focus:border-blue-600 focus:outline-none"
                                placeholder="Batch" v-model="batch" />
                        </div>
                        <div class="mb-4">
                            <input type="text"
                                class="w-full px-3 py-1.5 border border-gray-300 rounded focus:border-blue-600 focus:outline-none"
                                placeholder="Major" v-model="major" />
                        </div>
                        <div class="mb-4">
                            <input type="text"
                                class="w-full px-3 py-1.5 border border-gray-300 rounded focus:border-blue-600 focus:outline-none"
                        ...
                        <div class="mb-4">
                            <input type="text"
                                class="w-full px-3 py-1.5 border border-gray-300 rounded focus:border-blue-600 focus:outline-none"
                                placeholder="Place Of Birth" v-model="placeOfBirth" />
                        </div>
                        <div class="mb-4">
                            <select
                                class="w-full px-3 py-1.5 border border-gray-300 rounded focus:border-blue-600 focus:outline-none"
                                name="" id="" v-model="gender">
                    ...
                    <div class="mb-3 flex justify-between m-auto w-[90%]">
                        <button type="submit" class="flex justify-center m-auto w-[50%] text-blue-500 py-1  ml-[5%]"
                            @click="hideRegister">
