    ...
    <BaseForm class="relative mx-auto p-0 border w-90 shadow-lg rounded-lg bg-white " @click="stopInput">
        ...
        <template v-slot:form>
            <div class="relative z-0 mb-6 w-full group">
                <input type="text" placeholder=" " class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-200 appearance-none dark:text-black dark:border-blue-1000 dark:focus:border-blue-1000 focus:outline-none focus:ring-0 focus:border-blue-600 peer" v-model="school" @input="filterSchool">
            ...
            <div class="relative z-0 mb-6 w-full group">
                <input type="text" placeholder=" " class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-200 appearance-none dark:text-black dark:border-blue-1000 dark:focus:border-blue-1000 focus:outline-none focus:ring-0 focus:border-blue-600 peer" v-model="major" @input="filterMajor">
            ...
            <div class="p-3 flex justify-end">
                <BaseButton @click="hide" type="cancel" class="text-red-500 mr-2">Cancel</BaseButton>
                <BaseButton v-if="type=='create'" type="submit" class="bg-[#0062ff] sm:w-auto " @click="sendData">Add</BaseButton>
